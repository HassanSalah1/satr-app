...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | الأسطر التالية تحتوي على رسائل الأخطاء الافتراضية المستخدمة بواسطة
    | فئة التحقق (validator). بعض هذه القواعد لها إصدارات متعددة مثل
    ...
    */
    ...
    'ascii' => 'حقل :attribute يجب أن يحتوي فقط على أحرف أبجدية رقمية ورموز ذات بايت واحد.',
    ...
    'password' => [
        ...
        'uncompromised' => 'الـ :attribute المقدم ظهر في تسريب بيانات. الرجاء اختيار :attribute مختلف.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | الأسطر التالية تستخدم لاستبدال العنصر النائب للسمة
    | بشيء أكثر وضوحًا للقارئ مثل "عنوان البريد الإلكتروني" بدلاً من
    | "email". هذا يساعدنا في جعل رسالتنا أكثر تعبيرًا.
    |
    */
